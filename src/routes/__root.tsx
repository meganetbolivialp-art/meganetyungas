...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "MikroSystem — Administra tu red ISP" },
      { name: "twitter:description", content: "Software de administración ISP para Mikrotik. Control PPPoE, PCQ, Colas simples, Radius, facturación electrónica, corte y activaciones automáticas." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/223918ad-ddb0-4c55-a655-756a9ccf9d2b" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/223918ad-ddb0-4c55-a655-756a9ccf9d2b" },
    ],
    links: [
      {
        rel: "stylesheet",
